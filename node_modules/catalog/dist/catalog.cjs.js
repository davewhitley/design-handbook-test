/*! Catalog v3.5.2 https://www.catalog.style/ */
'use strict';
...
var toLower = _interopDefault(require('ramda/src/toLower'));
...
var getFontSize = function getFontSize(_ref) {
  ...
  return baseFontSize / 16 * Math.pow(msRatio, level) + "em";
};
...
var Paragraph = styled("p", function (props, _ref) {
  ...
  return _extends({}, text(theme), {
    flexBasis: "100%",
    margin: "16px 0 0 0"
  });
});
var UnorderedList = styled("ul", function (props, _ref2) {
  var theme = _ref2.theme;
  return _extends({}, baseListStyle, text(theme), {
    listStyle: "disc",
    marginTop: "16px",
    marginBottom: 0
  });
});
var OrderedList = styled("ol", function (props, _ref3) {
...
var ListItem = styled("li", function (props, _ref4) {
...
var BlockQuote = styled("blockquote", function (props, _ref5) {
...
var CodeSpan = styled("code", function (props, _ref6) {
...
var Del = styled("del", function (props, _ref7) {
...
var Link$2 = function Link$$1(props, _ref8) {
  var theme = _ref8.catalog.theme;
...
var AppLayout = function (_React$Component) {
  ...
  AppLayout.prototype.render = function render() {
    ...
    return React__default.createElement(
      ...
      React__default.createElement(
        "div",
        { className: /*#__PURE__*/ /*#__PURE__*/css(styles.content, "label:AppLayout;", "label:AppLayout;") },
        React__default.createElement(PageHeader, {
          theme: theme,
          title: page.title,
...
var replaceLast = function replaceLast(f, arr) {
  return arr.slice(0, -1).concat(f(arr[arr.length - 1]));
};
